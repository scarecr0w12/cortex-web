...
Manage communication channels that connect Cortex agents to external messaging platforms. Supports 10 channel integrations: Discord, Slack, Telegram, Microsoft Teams, Mattermost, Rocket.Chat, WhatsApp, Google Chat, Lark, and the built-in Web UI.
